                ...
                <div className={`container me-5 p-5 my-3 bg-${props.mode}`}>
                    <form onSubmit={btnSubmit}>
                        <div className="mb-3">
                            ...
                            <input type="name" className="form-control" id="name" name="name" value={credential.name} aria-describedby="emailHelp" onChange={clickChange} placeholder="Enter your name here"/>
                        </div>
                        <div className="mb-3">
                            ...
                            <span className="form-text mx-2">Enter a valid email address</span>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="password" className="form-label">Set Password</label>
                            <input type="password" className="form-control" id="password" name="password" value={credential.password} onChange={clickChange} minLength={8} required />
                            <span className="form-text mx-2">Password must be atleast 8 charcters including numbers & special characters</span>
                        </div>
                        <div className="mb-3">
