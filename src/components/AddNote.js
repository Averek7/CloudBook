            ...
            <div className={`m-3 p-3 bg-${props.mode}`}>
                ...
                <div className="container my-4">
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="title" name="title" value={note.title} placeholder="Enter title for your note" onChange={clickChange} minLength={5} required/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="description" className="form-label">Description</label>
                        <textarea className="form-control" id="description" name="description" value={note.description} rows="3" placeholder="Describe your note" onChange={clickChange} minLength={5} required></textarea>
                    </div>
                    <div className="mb-3">
                        <div className="mb-3">
